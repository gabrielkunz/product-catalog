sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.sap.build.standard.productCatalog.controller.ProductDetails", {
		handleRouteMatched: function(oEvent) {
			...
			if (!this.sContext) {
				this.sContext = "ProductSet('P3219')";
			}
		...
		_onTableItemPress1: function(oEvent) {
			...
			return new Promise(function(fnResolve) {
				this.doNavigate("Review", oBindingContext, fnResolve, "");
			}.bind(this)).catch(function(err) {
				if (err !== undefined) {
					MessageBox.error(err.message);
				}
		...
		onExit: function() {
			...
			var aControls = [{
				"controlId": "np-sap_uxap_ObjectPageSubSection-1444937231469-07J-blocks-build_simple_Table-1472711704272-5b9f02ab7124036d0e295aad5_S5",
				"groups": ["items"]
			}, {
				"controlId": "np-sap_uxap_ObjectPageSubSection-1444937233607-07U-blocks-build_simple_Table-1472711831798-5b9f02ab7124036d0e295aad5_S5",
				"groups": ["items"]
			}];
